...
class DataAnalystAgent(BaseITAgent):
    ...
    goal = (
        ...
        "Never state conclusions without supporting numbers."
    )
    backstory = (
        ...
        "Every claim you make is backed by a number. "
        "You rank findings by impact and always say what should be done first and why."
    )
